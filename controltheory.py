...
pinv = PseudoInverseController([f'q{i}' for i in range(len(robot.links))], K=np.eye(n), J=lambda x:robot.jac_geo(x)[0][:3, :], states_map=states_map)
